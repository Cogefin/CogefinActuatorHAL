...
|[OSL30561-IRA(秋月電子)][OSL30561IRA]|2.1(逆電圧:5)|M|
|[Grove - 4-Digit Display][Grove4DigitLED]|3.3～5.5|1|
|[3-Wire LED Module DFR0090][DFR0090]|不明|2|
...
|---|---|---|
|[Arduino Nano ESP32][NanoESP32]|Xtensa LX6|◯|
|[Arduino UNO R4 Minima][UnoR4Minima]|ARM Cortex-M4|◯1|
...
- 1 : IDE付属のサーボライブラリは使えないため，別途サーボライブラリの最新版をインストールする必要がある．
- 2 : サーボライブラリはGiga WiFiは動作保証外
